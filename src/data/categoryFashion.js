export const fashionSubcategories = [
  { 
    ...
    brands: [
      ...
      { name: 'Wildcraft', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/40/Wildcraft_logo.png/640px-Wildcraft_logo.png', url: 'https://track.vcommission.com/click?campaign_id=11277&pub_id=117026' },
      { name: 'Snitch', logo: 'https://snitchapp.imgix.net/Snitch_Logo_White.png', url: 'https://track.vcommission.com/click?campaign_id=10803&pub_id=117026' },
      { name: 'Mufti', logo: 'https://www.mufti.in/cdn/shop/files/mufti-logo-black_200x.png', url: 'https://track.vcommission.com/click?campaign_id=10712&pub_id=117026' },
      { name: 'Blackberrys', logo: 'https://www.blackberrys.com/cdn/shop/files/blackberrys-logo_200x.png', url: 'https://track.vcommission.com/click?campaign_id=10604&pub_id=117026' },
      { name: 'UNIQLO', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/92/UNIQLO_logo.svg/2560px-UNIQLO_logo.svg.png', url: 'https://track.vcommission.com/click?campaign_id=10258&pub_id=117026' },
    ]
  },
  {
    name: 'Footwear',
